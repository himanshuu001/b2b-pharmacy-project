...
// Configuration
const BACKEND_PORT = 1234; // Match this with your .env PORT when opening HTML file locally
const API_URL = window.location.protocol === 'file:' ? `http://localhost:${BACKEND_PORT}` : '';
